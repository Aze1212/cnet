...
TREE.Name = "Padawan Path"

--Description of the skill tree
TREE.Description = "Learn the way of the Jedi"
...
--Add user groups that are allowed to use this tree. If anyone is allowed, set this to FALSE ( TREE.UserGroups = false )
TREE.JobRestricted = { "TEAM_PADAWAN", "TEAM_KNIGHT", "TEAM_CONSULAR", "TEAM_SENTINEL", "TEAM_GUARDIAN", "TEAM_MASTER", "TEAM_COUNCIL" }
