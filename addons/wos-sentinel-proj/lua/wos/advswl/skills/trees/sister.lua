...
TREE.Name = "Nightsister"

--Description of the skill tree
TREE.Description = "Learn the way of the Nightsisters of Dagomir"
...
--Add user groups that are allowed to use this tree. If anyone is allowed, set this to FALSE ( TREE.UserGroups = false )
TREE.JobRestricted = { "TEAM_SISTER" }
...
TREE.Tier[1][2] = {
	Name = "Sisters Dagger",
	Description = "Strike from the shadows like a Sisters Assassin",
	Icon = "wos/forceicons/reflect.png",
	PointsRequired = 1,
	Requirements = {},
	OnPlayerSpawn = function( ply ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep:AddForcePower( "Sisters Dagger" ) end,
}

TREE.Tier[1][3] = {
	Name = "Force Heal",
	Description = "Channel Ichor to heal your friends or foes.",
	Icon = "wos/forceicons/reflect.png",
	PointsRequired = 1,
	Requirements = {},
	OnPlayerSpawn = function( ply ) end,
...
TREE.Tier[2][1] = {
	...
	OnPlayerSpawn = function( ply ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep:AddForcePower( "Sisters Apparitions" ) end,
}

TREE.Tier[2][2] = {
	Name = "Ichor Bolt",
	Description = "Form the Ichor in your blood into a living weapon.",
	Icon = "wos/forceicons/reflect.png",
	PointsRequired = 1,
	Requirements = {},
	OnPlayerSpawn = function( ply ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep:AddForcePower( "Ichor Bolt" ) end,
}

TREE.Tier[2][3] = {
    Name = "Damage 1",
    Description = "Adds 100 damage to your lightsaber",
...
TREE.Tier[3][2] = {
	Name = "Health 3",
	Description = "Adds 250 Health to your current Health",
	Icon = "wos/skilltrees/ravager/aid.png",
	PointsRequired = 1,
	Requirements = {},
	OnPlayerSpawn = function( ply ) ply:SetMaxHealth( ply:GetMaxHealth() + 250 ) end,
	OnPlayerDeath = function( ply ) end,
