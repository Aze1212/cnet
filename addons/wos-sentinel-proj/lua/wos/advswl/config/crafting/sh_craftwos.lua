...
wOS.ALCS.Config.Crafting.SaberMaxLevel = 100
...
wOS.ALCS.Config.Crafting.DefaultPersonalSaber.UseColor = Color( 8, 0, 255 )
...
wOS.ALCS.Config.Crafting.DefaultSecPersonalSaber.UseColor = Color( 8, 0, 255 )
