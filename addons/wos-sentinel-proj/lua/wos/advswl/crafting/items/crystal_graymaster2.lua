...
ITEM.Name = "Gray Jedi's Shield ( Dark Inner Smithed Orange )"

--The description that appears with the item name
ITEM.Description = "Touched by both the Force, and my cocks."
...
ITEM.OnEquip = function( wep )
	wep.CustomSettings[ "Blade" ] = "Smithed"
	wep.UseColor = Color(255, 153, 0, 255)
	wep.UseDarkInner = 1
end
