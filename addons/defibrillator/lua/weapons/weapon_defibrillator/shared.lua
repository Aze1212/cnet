...
SWEP.HPAfterRespawn = 200					-- HP the revived player will have after being revived
SWEP.TimeToRevive = 200						-- How many seconds should players be dead for before they can not be revived?
SWEP.ChargeTime = 6						-- How many seconds should charging the paddle keep a charge for?
