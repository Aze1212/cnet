...
SWEP.FirstShootSound = "masita/weapons/custom2/eleaticprinciplefire2.wav"
...
SWEP.AttachmentElements = {
    ["m5d"] = {
        VMElements = {
            {
                Model = "models/arccw/masita/jawa_pistol/jawa_pistol.mdl",
                Bone = "v_scoutblaster_reference001",
                Scale = Vector(1.2, 1.2, 1.2),
                Offset = {
                    pos = Vector(1, -0.5, -3.2),
                    ang = Angle(0.5, 180, 0)
                }
            }
        }
...
WMOverride = "models/arccw/masita/jawa_pistol/jawa_pistol.mdl"
...
SWEP.Attachments = {
    {
        ...
        Bone = "v_scoutblaster_reference001",
        Offset = {
            vpos = Vector(0.05, -1, 3.6),
            vang = Angle(0, 90, 0),
            wpos = Vector(300, 110, -490),
            wang = Angle(-10, -1, 180)
        },
    ...
    }, 
    {
        ...
        Offset = {
            vpos = Vector(0, -0.7, 8.7),
            vang = Angle(90, 0, -90),
            wpos = Vector(1375, 110, -600),
            wang = Angle(-10, 0, 180)
        },
    },  
    {
    ...
    },
    {
        ...
        Bone = "scoutblaster_sight",
        Offset = {
            vpos = Vector(0.7, -0.75, 2),
            vang = Angle(90, 0, -90),
            wpos = Vector(530, 200, -460),
            wang = Angle(-10, 0, 180)
        },
    },     
}
