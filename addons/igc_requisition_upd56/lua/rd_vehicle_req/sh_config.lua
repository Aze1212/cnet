...
NCS_REQUISITION.CFG = {
    ...
    currency = "darkrp",
    savevendors = "!vrsave",
    menucommand = "!vrconfig",
    camienabled = false,
    admins = {["superadmin"] = "World",},
    MEN_MODEL = "models/buggy.mdl", -- Menu Model (Default)
    NPC_MODEL = "models/hazel/dg_327th_models/talon_officer.mdl",
...
NCS_REQUISITION.CFG.Stances = {	
    "pose_standing_02", 
    "idle_all_01",
    "idle_all_02"
}

NCS_REQUISITION.DF_VEHICLE = {
    NAME = false,
    CLASS = false,
    CATEGORY = false,
    REQUEST = true,
