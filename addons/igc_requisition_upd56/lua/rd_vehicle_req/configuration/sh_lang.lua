...
function NCS_REQUISITION.AddLang(lang, note)
    RegisterLang(lang)
...
function NCS_REQUISITION.GetLang(lang, note, replacements)
    if !lang then
        lang = NCS_REQUISITION.CFG.langset or "en"
    end
...
function NCS_REQUISITION.GetLanguages()
    return LANG
end