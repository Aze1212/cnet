...
hook.Add("PlayerButtonDown", "NCS_REQUISITION_ButtonDown", function(P, BTN)
...
local function AddSpawn(UID, OFRAME, DUPLICATE)
    ...
    if UID and NCS_REQUISITION.SPAWNS[UID] then
        DATA = table.Copy(NCS_REQUISITION.SPAWNS[UID])
    else
        DATA = table.Copy(NCS_REQUISITION.DF_SPAWN)
    end
    ...
    P:Dock(TOP)
    P:SetText(NCS_REQUISITION.GetLang(nil, "VR_nameLabel").."*")
    P:DockMargin(0, 0, w * 0.01, h * 0.01)

    local TEXT = SCROLL:Add("DTextEntry")
    TEXT:Dock(TOP)
    TEXT:DockMargin(0, 0, w * 0.01, h * 0.01)
    TEXT:SetPlaceholderText(NCS_REQUISITION.GetLang(nil, "VR_nameLabel"))
    ...
    P:Dock(TOP)
    P:DockMargin(0, 0, w * 0.01, h * 0.01)
    P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_PosAng").."*")
    ...
    POS.DoClick = function()
        ...
        SendNotification(LocalPlayer(), NCS_REQUISITION.GetLang(nil, "VR_CFG_confirmPos"))
    ...
    local P = vgui.Create("PIXEL.Label", SCROLL)
    P:Dock(TOP)
    P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_requestTeams"))
    P:DockMargin(0, 0, w * 0.01, h * 0.01)

    local R_TEAMS = SCROLL:Add("DListView")
    R_TEAMS:Dock(TOP)
    R_TEAMS:AddColumn( NCS_REQUISITION.GetLang(nil, "VR_nameLabel") )
    ...
    local P = vgui.Create("PIXEL.Label", SCROLL)
    P:Dock(TOP)
    P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_requestRanks"))
    P:DockMargin(0, 0, w * 0.01, h * 0.01)
    ...
    BRANCH:SetPlaceholderText(NCS_REQUISITION.GetLang(nil, "VR_CFG_branchLabel"))
    BRANCH:SetWide(BRANCH:GetWide() * 2)

    RANK = vgui.Create("DTextEntry", LABEL)
    RANK:Dock(LEFT)
    RANK:SetKeyboardInputEnabled(true)
    RANK:SetPlaceholderText(NCS_REQUISITION.GetLang(nil, "VR_CFG_rankLabel"))
    ...
    R_RANK:Dock(FILL)
    R_RANK:AddColumn( NCS_REQUISITION.GetLang(nil, "VR_CFG_branchLabel"), 1 )
    R_RANK:AddColumn( NCS_REQUISITION.GetLang(nil, "VR_CFG_rankLabel"), 2 )
    ...
    local P = vgui.Create("PIXEL.Label", SCROLL)
    P:Dock(TOP)
    P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_grantTeams"))
    P:DockMargin(0, 0, w * 0.01, h * 0.01)

    local G_TEAMS = SCROLL:Add("DListView")
    G_TEAMS:Dock(TOP)
    G_TEAMS:AddColumn( NCS_REQUISITION.GetLang(nil, "VR_nameLabel") )
    ...
    local P = vgui.Create("PIXEL.Label", SCROLL)
    P:Dock(TOP)
    P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_grantRanks"))
    P:DockMargin(0, 0, w * 0.01, h * 0.01)
    ...
    G_RANK:Dock(FILL)
    G_RANK:AddColumn( NCS_REQUISITION.GetLang(nil, "VR_CFG_branchLabel"), 1 )
    G_RANK:AddColumn( NCS_REQUISITION.GetLang(nil, "VR_CFG_rankLabel"), 2 )
    ...
    CONFIRM:Dock(BOTTOM)
    CONFIRM:SetText(NCS_REQUISITION.GetLang(nil, "VR_saveLabel"))
    ...
    CONFIRM.DoClick = function()
        ...
        surface.PlaySound("reality_development/ui/ui_accept.ogg")
        SendNotification(LocalPlayer(), NCS_REQUISITION.GetLang(nil, "VR_CFG_savedSuccess"))
...
local function AddVehicle(UID, OFRAME, DUPLICATE)
    ...
    if UID and NCS_REQUISITION.VEHICLES[UID] then
        DATA = table.Copy(NCS_REQUISITION.VEHICLES[UID])
    else
        DATA = table.Copy(NCS_REQUISITION.DF_VEHICLE)
    end
    ...
    P:Dock(TOP)
    P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_defaultSkin"))
    ...
    local P = vgui.Create("PIXEL.Label", INFOTAB)
    P:Dock(TOP)
    P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_defaultLoadout"))
    P:DockMargin(0, 0, 0, h * 0.01)

    local DFLOADOUT = vgui.Create("DComboBox", INFOTAB)
    DFLOADOUT:Dock(TOP)

    local C = DFLOADOUT:AddChoice(NCS_REQUISITION.GetLang(nil, "VR_CFG_default"), false)
    ...
    local function ResetSkinChoices()
        ...
        local C = DFSKIN:AddChoice(NCS_REQUISITION.GetLang(nil, "VR_CFG_default"), false)
        DFSKIN:ChooseOptionID(C)

        if !DATA.MODEL then return end

        for i = 1, NumModelSkins(DATA.MODEL) do
            local CHOICE = DFSKIN:AddChoice(NCS_REQUISITION.GetLang(nil, "VR_skinLabel").." "..i, i)
    ...
    SIDEBAR:AddItem("main", "Main", "MQfnROH", function()
        ...
        local P = vgui.Create("PIXEL.Label", SCROLL)
        P:Dock(TOP)
        P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_categoryLabel").."*")
        P:DockMargin(0, 0, w * 0.01, h * 0.01)

        local CATEGORY = SCROLL:Add("DTextEntry")
        CATEGORY:Dock(TOP)
        CATEGORY:SetPlaceholderText(NCS_REQUISITION.GetLang(nil, "VR_CFG_categoryLabel"))
        ...
        local P = vgui.Create("PIXEL.Label", SCROLL)
        P:Dock(TOP)
        P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_classLabel").."*")
        P:DockMargin(0, 0, w * 0.01, h * 0.01)

        local CLASS = SCROLL:Add("DTextEntry")
        CLASS:Dock(TOP)
        CLASS:SetPlaceholderText(NCS_REQUISITION.GetLang(nil, "VR_CFG_classLabel"))
        ...
        local P = vgui.Create("PIXEL.Label", SCROLL)
        P:Dock(TOP)
        P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_priceLabel"))
        P:DockMargin(0, 0, w * 0.01, h * 0.01)

        local PRICE = SCROLL:Add("DTextEntry")
        PRICE:Dock(TOP)
        PRICE:SetPlaceholderText(NCS_REQUISITION.GetLang(nil, "VR_CFG_priceLabel"))
        ...
        local P = vgui.Create("PIXEL.Label", SCROLL)
        P:Dock(TOP)
        P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_maxAmount"))
        P:DockMargin(0, 0, w * 0.01, h * 0.01)

        local MAX = SCROLL:Add("DTextEntry")
        MAX:Dock(TOP)
        MAX:SetPlaceholderText(NCS_REQUISITION.GetLang(nil, "VR_CFG_maxAmount"))
        MAX:SetNumeric(true)
        ...
        local P = vgui.Create("PIXEL.Label", SCROLL)
        P:Dock(TOP)
        P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_enableRequests"))
        P:DockMargin(0, 0, w * 0.01, h * 0.01)
        ...
        local P = vgui.Create("PIXEL.Label", SCROLL)
        P:Dock(TOP)
        P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_whitelistedHangars"))
        P:DockMargin(0, 0, w * 0.01, h * 0.01)

        local HANGARS = SCROLL:Add("DListView")
        HANGARS:Dock(TOP)
        HANGARS:AddColumn( NCS_REQUISITION.GetLang(nil, "VR_nameLabel") )
        HANGARS:AddColumn( NCS_REQUISITION.GetLang(nil, "VR_CFG_UIDLabel") )
    ...
    SIDEBAR:AddItem("skins", NCS_REQUISITION.GetLang(nil, "VR_CFG_skins"), "21Xc7qO", function()
        ...
        for i = 1, NumModelSkins(DATA.MODEL) do
            ...
            if DATA.S_CONFIG and DATA.S_CONFIG[i] and DATA.S_CONFIG[i].NAME then
                ...
                SKIN:SetText(NCS_REQUISITION.GetLang(nil, "VR_skinLabel").." "..i)
            end
            ...
            SKIN.DoClick = function()
                ...
                P:Dock(TOP)
                P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_skinEnabled"))
                P:DockMargin(0, 0, w * 0.01, h * 0.01)
                ...
                timer.Create("NCS_REQUISITION_ResetSkin", 5, 1, function()
    ...
    SIDEBAR:AddItem("loadouts", NCS_REQUISITION.GetLang(nil, "VR_CFG_loadouts"), "83ttlX9", function()
        if !DATA.MODEL or DATA.MODEL == "" then return end

        local L_createLoadout = NCS_REQUISITION.GetLang(nil, "VR_CFG_createLoadout")
        ...
        COMBO:SetValue(NCS_REQUISITION.GetLang(nil, "VR_CFG_selectLoadout"))
        COMBO:Dock(TOP)
        COMBO.OnSelect = function(s, I, T, OTHER)
            ...
            NAME:SetPlaceholderText(NCS_REQUISITION.GetLang(nil, "VR_nameLabel"))
            NAME:Dock(TOP)
        ...
        DEL_BUTTON:SetText(NCS_REQUISITION.GetLang(nil, "VR_deleteLabel"))
...
net.Receive("NCS_REQUISITION_ADMIN", function()
    local FRAME = vgui.Create("PIXEL.Frame")
    FRAME:SetSize(ScrW() * 0.3, ScrH() * 0.6)
    FRAME:Center()
    FRAME:MakePopup(true)
    ...
    PANEL.Paint = function(s)
        ...
        SB:AddItem("adminMenu", "Admin", "6JrFWlz", function()
            if IsValid(PANEL) then PANEL:Clear() end
    
            local DATA = table.Copy(NCS_REQUISITION.CFG)
            ...
            local S = vgui.Create("DScrollPanel", PANEL)
            S:Dock(FILL)
    
            -- Cami Time
            local M_LABEL = S:Add("DLabel")
            M_LABEL:SetText(NCS_REQUISITION.GetLang(nil, "camiEnabled"))
            M_LABEL:Dock(TOP)
            ...
            NoCAMIFuckU = function()
                local M_LABEL = S:Add("DLabel")
                M_LABEL:SetText(NCS_REQUISITION.GetLang(nil, "adminGroups"))
                M_LABEL:Dock(TOP)
                M_LABEL:DockMargin(w * 0.025, h * 0.025, w * 0.025, h * 0.025)
                ...
                TX_USERGROUP:SetPlaceholderText(NCS_REQUISITION.GetLang(nil, "adminGroups"))
                ...
                TX_UGLIST:Dock(FILL)
                TX_UGLIST:AddColumn( NCS_REQUISITION.GetLang(nil, "adminGroups"), 1 )
                TX_UGLIST:AddColumn( NCS_REQUISITION.GetLang(nil, "addedBy"), 2 )
            ...
            SEND:Dock(BOTTOM)
            SEND:SetText(NCS_REQUISITION.GetLang(nil, "VR_saveLabel"))
        ...
        SB:AddItem("generalConfig", NCS_REQUISITION.GetLang(nil, "VR_CFG_options"), "aYJTAUa", function()
            PANEL:Clear()
            ...
            local M_LABEL = SCROLL:Add("DLabel")
            M_LABEL:SetText(NCS_REQUISITION.GetLang(nil, "addonLang"))
            M_LABEL:Dock(TOP)
            M_LABEL:DockMargin(0, 0, w * 0.01, h * 0.01)
        
            local LANG = SCROLL:Add("DComboBox")
            LANG:Dock(TOP)
            LANG:DockMargin(0, 0, w * 0.01, h * 0.01)
            
            LANG.OnSelect = function(s, IND, VAL)
                DATA.langset = VAL
            end
        
            for k, v in pairs(NCS_REQUISITION.GetLanguages()) do
            ...
            local M_LABEL = SCROLL:Add("DLabel")
            M_LABEL:SetText(NCS_REQUISITION.GetLang(nil, "addonCurrency"))
            M_LABEL:Dock(TOP)
            M_LABEL:DockMargin(0, 0, w * 0.01, h * 0.01)
            ...
            for k, v in pairs(NCS_REQUISITION.CURRENCIES) do
                local OPT = LANG:AddChoice(k)
            ...
            local P = vgui.Create("PIXEL.Label", SCROLL)
            P:Dock(TOP)
            P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_npcModel"))
            P:DockMargin(0, 0, w * 0.01, h * 0.01)
            ...
            local P = vgui.Create("PIXEL.Label", SCROLL)
            P:Dock(TOP)
            P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_menuModel"))
            P:DockMargin(0, 0, w * 0.01, h * 0.01)
            ...
            local P = vgui.Create("PIXEL.Label", SCROLL)
            P:Dock(TOP)
            P:SetText(NCS_REQUISITION.GetLang(nil, "configcommand"))
            P:DockMargin(0, 0, w * 0.01, h * 0.01)
            ...
            if DATA.menucommand and ( DATA.menucommand ~= "" ) then
                OPTION_menuModel:SetText(DATA.menucommand)
            end
            ...
            local P = vgui.Create("PIXEL.Label", SCROLL)
            P:Dock(TOP)
            P:SetText(NCS_REQUISITION.GetLang(nil, "saveVendors"))
            P:DockMargin(0, 0, w * 0.01, h * 0.01)
            ...
            OPTION_menuModel:DockMargin(0, 0, w * 0.01, h * 0.01)
            OPTION_menuModel.OnChange = function(s, val)
                DATA.savevendors = s:GetValue()
            end
    
            if DATA.savevendors and ( DATA.savevendors ~= "" ) then
                OPTION_menuModel:SetText(DATA.savevendors)
            end
            ...
            local P = vgui.Create("PIXEL.Label", SCROLL)
            P:Dock(TOP)
            P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_overheadAccent"))
            P:DockMargin(0, 0, w * 0.01, h * 0.01)
            ...
            OPTION_overheadColor.Think = function(s)
                DATA.OVR_COLOR = s:GetColor()
            end
            ...
            local P = vgui.Create("PIXEL.Label", SCROLL)
            P:Dock(TOP)
            P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_prefixText"))
            P:DockMargin(0, 0, w * 0.01, h * 0.01)
            ...
            local P = vgui.Create("PIXEL.Label", SCROLL)
            P:Dock(TOP)
            P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_prefixColor"))
            P:DockMargin(0, 0, w * 0.01, h * 0.01)
            ...
            OPTION_prefixColor.Think = function(s)
                DATA.PRE_COLOR = s:GetColor()
            end
            ...
            local P = vgui.Create("PIXEL.Label", SCROLL)
            P:Dock(TOP)
            P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_autoDenyTime"))
            P:DockMargin(0, 0, w * 0.01, h * 0.01)
            ...
            local P = vgui.Create("PIXEL.Label", SCROLL)
            P:Dock(TOP)
            P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_maxVehicles"))
            P:DockMargin(0, 0, w * 0.01, h * 0.01)
            ...
            local P = vgui.Create("PIXEL.Label", SCROLL)
            P:Dock(TOP)
            P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_spawnpointRadius"))
            P:DockMargin(0, 0, w * 0.01, h * 0.01)
            ...
            local P = vgui.Create("PIXEL.Label", SCROLL)
            P:Dock(TOP)
            P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_spawnpointMaxDistance"))
            P:DockMargin(0, 0, w * 0.01, h * 0.01)
            ...
            local P = vgui.Create("PIXEL.Label", SCROLL)
            P:Dock(TOP)
            P:SetText(NCS_REQUISITION.GetLang(nil, "VR_CFG_randomizeVendor"))
            P:DockMargin(0, 0, w * 0.01, h * 0.01)
            ...
            local P = vgui.Create("PIXEL.Label", SCROLL)
            P:Dock(TOP)
            P:SetText(NCS_REQUISITION.GetLang(nil, "VR_enableSelfGrant"))
            ...
            local P = vgui.Create("PIXEL.Label", SCROLL)
            P:Dock(TOP)
            P:SetText(NCS_REQUISITION.GetLang(nil, "VR_displaySpawnLocations"))
        ...
        SB:AddItem("vehiclesMenu", NCS_REQUISITION.GetLang(nil, "VR_vehiclesLabel"), "0w4PAfy", function()
            PANEL:Clear()
            ...
            LIST:AddColumn( NCS_REQUISITION.GetLang(nil, "VR_nameLabel") )
            LIST:AddColumn( NCS_REQUISITION.GetLang(nil, "VR_CFG_creatorLabel")  )
            LIST:AddColumn( NCS_REQUISITION.GetLang(nil, "VR_CFG_UIDLabel")  )

            LIST.OnRowRightClick = function(_, ID, LINE)
                local MenuButtonOptions = DermaMenu()

                MenuButtonOptions:AddOption(NCS_REQUISITION.GetLang(nil, "VR_editLabel"), function()
                    AddVehicle(LINE.UID, FRAME)
                end)

                MenuButtonOptions:AddOption(NCS_REQUISITION.GetLang(nil, "VR_dupeLabel"), function()
                    AddVehicle(LINE.UID, FRAME, true)
                end)

                MenuButtonOptions:AddOption(NCS_REQUISITION.GetLang(nil, "VR_deleteLabel"), function()
        ...
        SB:AddItem("spawnsMenu", NCS_REQUISITION.GetLang(nil, "VR_spawnsLabel"), "d9G08E4", function()
            PANEL:Clear()
...
net.Receive("NCS_REQUISITION_AddSpawn", function()
...
net.Receive("NCS_REQUISITION_DelSpawn", function()
...
net.Receive("NCS_REQUISITION_AddVehicle", function()
    local LEN = net.ReadUInt(32)
    local DATA = net.ReadData(LEN)
...
net.Receive("NCS_REQUISITION_DelVehicle", function()
    local UID = net.ReadString()
...
net.Receive("NCS_REQUISITION_BatchSend", function()
    ...
    NCS_REQUISITION.VEHICLES = V_DECOMP

    local H_DECOMP = util.JSONToTable(util.Decompress(H_DATA))
    NCS_REQUISITION.SPAWNS = H_DECOMP
end )

net.Receive("NCS_REQUISITION_SaveSettings", function()
    local LEN = net.ReadUInt(32)
    local DATA = net.ReadData(LEN)
