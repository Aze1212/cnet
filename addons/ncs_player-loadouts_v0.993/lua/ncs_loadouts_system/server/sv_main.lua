...
net.Receive("NCS_LOADOUTS_GivePlayerCert", function(_, P)
    NCS_LOADOUTS.IsAdmin(P, function(ACCESS)
        ...
        if NCS_LOADOUTS.CONFIG.teamrestrictcerts and table.Count(NCS_LOADOUTS.CONFIG.teamrestrictcerts) > 0 and NCS_LOADOUTS.CONFIG.teamrestrictcerts[team.GetName()] then
            ACCESS = true
        end
